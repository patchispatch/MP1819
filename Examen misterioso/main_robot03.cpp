...
dimensionar un vector de Robot original, con el tamaño necesario para almacenar una serie de robotes.
Todos tienen id, 2 coordenadas y una potencia de acción (alcance).
...
(no muertos) resultante de aplicar el robot inhibidor, el vector resultante tambien es de tamaño ajustado.
...
En ambos casos deberá entregar el makefile, propio o generado por netbeans.
*/
