...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pr_ctica_final: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pr_ctica_final ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -lX11
...
${OBJECTDIR}/src/utilidades.o: src/utilidades.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utilidades.o src/utilidades.cpp
